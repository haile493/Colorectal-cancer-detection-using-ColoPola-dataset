...
Source code: https://github.com/snap-research/EfficientFormer
"""
import os
import copy
import torch
...
# in this study, use mean0 and std0 as calculated on ColoPola dataset
...
class Attention4DDownsample(torch.nn.Module):
    ...
    def forward(self, x):  # x (B,N,C)
        ...
        # @ symbol is for matrix multiplication since Python 3.5
        attn = (
                (q @ k) * self.scale
                +
                (self.attention_biases[:, self.attention_bias_idxs]
...
class EfficientFormerV2(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        """
        pass  # training start from scratch
...
def _cfg(url='', **kwargs):
    return {
        ...
        'num_classes': 1, 'input_size': (36, 224, 224), 'pool_size': None,
